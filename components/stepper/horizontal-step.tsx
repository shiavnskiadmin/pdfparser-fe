    ...
    return (
      <div
        ...
        className={cn(
          ...
          "flex items-center relative transition-all ease-in duration-500",
          "[&:not(:last-child)]:flex-1",
          "[&:not(:last-child)]:after:transition-all [&:not(:last-child)]:after:ease-out [&:not(:last-child)]:after:duration-700",
